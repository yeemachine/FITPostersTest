...
$('#lazy-container').on('scroll', function () {
  if (state === 'mobile'){
    ...
    if (calc2 > '1') {
        $('.page3 .bookIntro h3, .page4 .bookIntro:nth-child(1) h3 div:nth-child(1)').css({ 'opacity': 1 });
    } else if ( calc2 < '0' ) {
        $('.page3 .bookIntro h3, .page4 .bookIntro:nth-child(1) h3 div:nth-child(1)').css({ 'opacity': 0 });
    }
    if (calc3 > '1') {
        $('.intro').css({ 'opacity': 1 });
    } else if ( calc3 < '0' ) {
